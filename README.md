...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/chat
```

A live public deployment of this template is available at [https://chat.templates.workers.dev](https://chat.templates.workers.dev)
